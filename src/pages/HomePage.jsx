    ...
    return (
        <div>
            ...
            <div className="filter-container"> Apply Filters: <span role="img" aria-label="cupcake">🧁</span> 
                ...
                <button className="filters" type='button' name="Pastry" onClick={changeFilter}>Pastry</button>
                <button className="filters" type='button' name="Cookies" onClick={changeFilter}>Cookies</button>
                <button className="filters" type='button' name="Other" onClick={changeFilter}>Other</button>
                <button className="filters" id="remove-filters" type='button' name="All" onClick={changeFilter}>Remove Filters</button>
            </div>
            <div id="project-list">
